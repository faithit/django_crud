...
def index(request):
    ...
    carousel_items=Product.objects.filter(image__isnull=False).exclude(image__exact='')[:3]
    return render(request, 'index.html',{'products':products,'carousel_items':carousel_items})
